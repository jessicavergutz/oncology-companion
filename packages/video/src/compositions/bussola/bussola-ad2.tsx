...
import { ad2ScenesData } from '../../data/bussola/bussola-ad2-data';

/* ───────────────────────────────────────────
   CINEMATIC SCENE COMPONENT — AD2
   "O Momento do Instagram"
   ─────────────────────────────────────────── */
...
/* ───────────────────────────────────────────
   MAIN COMPOSITION — AD2
   ─────────────────────────────────────────── */
export const BussolaAd2 = () => {
	const CROSSFADE = 15;
	return (
		<AbsoluteFill style={{ backgroundColor: '#643A1F' }}>
			<Audio src={staticFile('audio/ad2.mp3')} />
			{ad2ScenesData.map((scene, index) => {
				const isLast = index === ad2ScenesData.length - 1;
