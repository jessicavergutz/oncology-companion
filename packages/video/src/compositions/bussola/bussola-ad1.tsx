...
import { ad1ScenesData } from '../../data/bussola/bussola-ad1-data';

/* ───────────────────────────────────────────
   CINEMATIC SCENE COMPONENT — AD1
   "A Espiral das 3h da Manhã"
   ─────────────────────────────────────────── */
...
/* ───────────────────────────────────────────
   MAIN COMPOSITION — AD1
   ─────────────────────────────────────────── */
export const BussolaAd1 = () => {
	const CROSSFADE = 15;
	return (
		<AbsoluteFill style={{ backgroundColor: '#643A1F' }}>
			<Audio src={staticFile('audio/ad1.mp3')} />
			{ad1ScenesData.map((scene, index) => {
				const isLast = index === ad1ScenesData.length - 1;
