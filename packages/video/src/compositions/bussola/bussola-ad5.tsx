...
import { ad5ScenesData } from '../../data/bussola/bussola-ad5-data';
...
export const BussolaAd5 = () => {
	...
	return (
		<AbsoluteFill style={{ backgroundColor: '#643A1F' }}>
			...
			<Audio src={staticFile('audio/ad5.mp3')} volume={volume} />

			{ad5ScenesData.map((scene, index) => {
				const isLast = index === ad5ScenesData.length - 1;
